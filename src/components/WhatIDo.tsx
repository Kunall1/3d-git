        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Customer-Led Product Thinking</h4>
              <p>
                I drive product discovery, user research, and roadmap
                prioritisation — turning 300+ customer conversations into
                actionable product decisions and feature scoping.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>BUILD &amp; SHIP</h3>
              <h4>AI-Native Prototyping &amp; Development</h4>
              <p>
                I prototype and ship product features independently using
                AI-assisted workflows — Claude Code, Vercel, Cursor — going
                from idea to deployed product fast.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
